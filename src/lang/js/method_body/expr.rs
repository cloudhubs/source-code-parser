use crate::js::method_body::node::{parse_child_nodes, parse_node};
use crate::js::method_body::parse_block;
use crate::js::util::parameter::parse_method_parameters;
use crate::js::util::vartype::parse_type_args;
use crate::js::{method_body::log_unknown_tag, util::vartype::find_type};
...
pub(crate) fn parse_expr(ast: &AST, component: &ComponentInfo) -> Option<Expr> {
    match &*ast.r#type {
        ...
        "member_expression" => parse_field_access(ast, component),
        ...
        "new_expression" => Some(parse_object_creation(ast, component)),
