use crate::js::method_body::log_unknown_tag;
use crate::js::method_def::parse_method;
use crate::js::modifier::{find_modifier, parse_modifiers, Modifier};
...
fn parse_field(ast: &AST, component: &ComponentInfo) -> Vec<FieldComponent> {
    let variables: Vec<String> = ast
        ...
        .get_or_insert(vec![])
        .iter()
        .flat_map(|var_decl| var_decl.find_child_by_type(&["property_identifier"]))
